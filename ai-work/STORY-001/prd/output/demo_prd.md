...
The input material is a clearly marked technical validation sample.
...
```text
## synthetic_demo_request.md
Technical validation sample: verify that the AI governance demo can produce a PRD artifact, a Skill audit report, and a usage evaluation JSON.
```
